...
class MyApp extends LitElement {
    ...
    firstUpdated() {
        ...
        this.toast = this.shadowRoot?.querySelector("lit-toast") ?? null;
        // If 'path' or 'composedPath()' unavailable, don't show options
        this.addEventListener("click", (event) => { this._showOptions = event.composed; });
        this.click();
    }
    _callToast() {
...
], MyApp.prototype, "toast", void 0);
__decorate([
    state()
], MyApp.prototype, "_showOptions", void 0);
__decorate([
    state()
], MyApp.prototype, "_message", void 0);
__decorate([
    state()
], MyApp.prototype, "_padding", void 0);
__decorate([
    state()
], MyApp.prototype, "_bottom", void 0);
__decorate([
    state()
], MyApp.prototype, "_zIndex", void 0);
__decorate([
    state()
], MyApp.prototype, "_fontSize", void 0);
__decorate([
    state()
], MyApp.prototype, "_borderRadius", void 0);
__decorate([
    state()
], MyApp.prototype, "_border", void 0);
__decorate([
    state()
], MyApp.prototype, "_color", void 0);
__decorate([
    state()
], MyApp.prototype, "_backgroundColor", void 0);
__decorate([
    state()
], MyApp.prototype, "_fontFamily", void 0);
MyApp = __decorate([
